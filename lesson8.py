...
class Warehouse84:
    ...
    def profit(self, nom, nom_dict, count):
        """
        Перемещение на склад номенклатуры
        :param nom:  Номенклатурный номер
        :param nom_dict:  Словарь данных помещенной на склад номенклатуры
        :param count: Количество
        :return:  Возвращает сообщение об ошибке при несоответствии данных
        """
        try:
            profit_loc(nom, nom_dict, count, self.nom, self.remains)
        except TypeError:
            return f"Несоответствие типов данных"

    def cost(self, nom, nom_dict, count):
        """
        Изъятие со склада номенклатуры
        :param nom: Номенклатурный номер
        :param nom_dict: Словарь данных изъятой со склада номенклатуры
        :param count: Количество
        :return: Возвращает сообщение об ошибке при несоответствии данных
        """
        try:
    ...
    def save(self, filename):
        ...
        :param filename: Файл с данными в формате json
    ...
    def read(self, filename):
        """
        Восстановление ранее введенных данных из файла в словарь
        :param filename: Файл с данными в формате json
        :return: Возвращает словарь для класса Warehouse
        """
        try:
    ...
    def counts(dicts):
        """
        Статический метод, для подсчета общего количества номенклатуры на складе
        :param dicts: Принимает словарь номенклатуры на складе
        :return: Возвращает общее количество единиц
        """
        result = 0
        for i in dicts:
...
class OfficeEquipment84:
    ...
    def profit_wharehouse(self):
        """
        Создание словаря номенклатуры
        :return: Возвращает словарь номенклатуры
        """
